...
from integration.machine.ha.continuous_writes import ContinuousWrites
from integration.machine.helpers import (
    APP_NAME,
    DUMMY_NAME,
    REL_NAME_ADMIN,
)
from integration.machine.helpers.ha import (
...
def test_scale_out(juju: jubilant.Juju, controller_app, kafka_apps, kraft_mode):
    assert juju.model
...
def test_scale_in(juju: jubilant.Juju, controller_app, kafka_apps, kraft_mode):
    assert juju.model
