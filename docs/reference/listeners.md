...
Internal (broker-controller and inter-broker) communications always use `SASL_SSL`. When no
`peer-certificates` relation is present, the charm uses auto-generated self-signed certificates
