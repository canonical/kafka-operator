...
Reference for the
[Charmed Apache Kafka Terraform module](https://github.com/canonical/kafka-bundle/tree/main/terraform),
used with the
...
The `broker`, `controller`, `connect`, `karapace`, `ui`, and `integrator` variables accept objects
...
[module source](https://github.com/canonical/kafka-bundle/tree/main/terraform) for the full list of
defaults.
