...
```{note}
For more information on how to authenticate, refer to the [Juju documentation](https://canonical.com/juju/docs/juju-cli/3.6/reference/cloud/list-of-supported-clouds/microsoft-azure/#authentication-types).
```
