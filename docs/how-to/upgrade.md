...
```{warning}
Major workload upgrades are generally **NOT SUPPORTED**. 
They should be carried out using [full cluster-to-cluster migrations](how-to-cluster-replication-migrate-a-cluster).
```
