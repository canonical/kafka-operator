...
`/var/snap/charmed-kafka/common/etc/kafka/client.properties` file present on every Apache Kafka
...
For instance, in order to list the current topics on the Apache Kafka cluster, you can run:
