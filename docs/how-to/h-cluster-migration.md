...
Once confident in the successful completion of the data a client migration, the running processes on each of the charm units can be stopped, stopping the MirrorMaker processes active on the Charmed Kafka cluster.