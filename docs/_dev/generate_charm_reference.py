...
_AUTOGEN_NOTICE = (
    ...
    "Edit machine/actions.yaml or machine/config.yaml and rebuild. -->"
)
...
def generate_configurations_page(config_data: dict[str, Any]) -> str:
    ...
    lines.append("")
    lines.append(
        "See the [Juju documentation]"
        "(https://canonical.com/juju/docs/juju/cli/commands/juju-config) "
        "for more information on configuring applications."
    )
    lines.append("")
